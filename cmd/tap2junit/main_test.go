...
`,
   ...
   <testsuites tests="2" failures="1" time="20.000">
      <testsuite id="7cc84235ce3aaeab160cebf213fdff2a0d92dcb4e6304dee5fb2762673f107f1" name="named_test" tests="2" failures="1" time="20.000">
	...
	for _, test := range tests {
		...
		t.Run(test.name, func(t *testing.T) {
			...
			run(strings.NewReader(test.input), &b, "named_test")
